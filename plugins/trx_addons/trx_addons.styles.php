...
if (!function_exists('chocorocco_trx_addons_get_css')) {
	add_filter('chocorocco_filter_get_css', 'chocorocco_trx_addons_get_css', 10, 4);
	function chocorocco_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.search_style_fullscreen.search_opened .search_field::-webkit-input-placeholder {color:{$colors['text']};}
.search_style_fullscreen.search_opened .search_field::-moz-placeholder          {color:{$colors['text']};}/* Firefox 19+ */
.search_style_fullscreen.search_opened .search_field:-moz-placeholder           {color:{$colors['text']};}/* Firefox 18- */
.search_style_fullscreen.search_opened .search_field:-ms-input-placeholder      {color:{$colors['text']}; }
...
.sc_item_slider.slider_outer_pagination .swiper-pagination-bullet:hover,
