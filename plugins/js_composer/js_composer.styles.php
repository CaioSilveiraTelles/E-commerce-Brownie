...
if ( !function_exists( 'chocorocco_vc_get_css' ) ) {
	add_filter( 'chocorocco_filter_get_css', 'chocorocco_vc_get_css', 10, 4 );
	function chocorocco_vc_get_css($css, $colors, $fonts, $scheme='') {
