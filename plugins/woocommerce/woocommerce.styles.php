...
if ( !function_exists( 'chocorocco_woocommerce_get_css' ) ) {
	add_filter( 'chocorocco_filter_get_css', 'chocorocco_woocommerce_get_css', 10, 4 );
	function chocorocco_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
/*Sort buttons*/
.woocommerce .chocorocco_shop_mode_buttons a,
.woocommerce-page .chocorocco_shop_mode_buttons a {
...
.woocommerce .chocorocco_shop_mode_buttons a:hover,
.woocommerce-page .chocorocco_shop_mode_buttons a:hover,
.woocommerce .shop_mode_thumbs .chocorocco_shop_mode_buttons a.woocommerce_thumbs,
.woocommerce-page .shop_mode_thumbs .chocorocco_shop_mode_buttons a.woocommerce_thumbs,
.woocommerce .shop_mode_list .chocorocco_shop_mode_buttons a.woocommerce_list,
.woocommerce-page .shop_mode_list .chocorocco_shop_mode_buttons a.woocommerce_list {
  color: {$colors['text']};
}
...
/* Buttons */
.chocorocco_shop_mode_buttons a {
	color: {$colors['text_dark']};
}
.chocorocco_shop_mode_buttons a:hover {
	color: {$colors['text_link']};
}
