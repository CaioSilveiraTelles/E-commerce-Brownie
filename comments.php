							...
							<div class="comment_info">
								<div class="comment_posted">
									...
									<span class="comment_date"><?php
										echo chocorocco_get_date(get_comment_date('U'));	//get_comment_date(get_option('date_format'));
									?></span>
				...
				$chocorocco_comments_args = apply_filters( 'chocorocco_filter_comment_form_args', array(
						...
						'fields' => array(
							'author' => chocorocco_single_comments_field(array(
												...
												'field_name' => 'author',
												'field_title' => esc_html__('Name', 'chocorocco'),
												'field_placeholder' => esc_html__( 'Your Name', 'chocorocco' )
											)),
							'email' => chocorocco_single_comments_field(array(
												...
												'field_name' => 'email',
												'field_title' => esc_html__('E-mail', 'chocorocco'),
												'field_placeholder' => esc_html__( 'Your E-mail', 'chocorocco' )
											))
						),
						...
						'comment_field' => chocorocco_single_comments_field(array(
												...
												'field_value' => '',
												'field_name' => 'comment',
												'field_title' => esc_html__('Comment', 'chocorocco'),
												'field_placeholder' => esc_html__( 'Your comment', 'chocorocco' )
											)),
				));
