...
if (trx_addons_exists_woocommerce()) {
	...
	?><div<?php if (!empty($args['id'])) echo ' id="'.esc_attr($args['id']).'"'; ?> class="sc_layouts_cart<?php
		...
		<span class="sc_layouts_item_details sc_layouts_cart_details">
			<span class="sc_layouts_item_details_line2 sc_layouts_cart_label"><?php echo !empty($args['text']) ? esc_html($args['text']) : esc_html__('Shopping Cart', 'chocorocco');
			?></span><span class="sc_layouts_item_details_line2 sc_layouts_cart_totals"><span class="sc_layouts_cart_items"><?php
